...
# 配置文件 ./.zshrc 
genSignS zshplugins $TEMP/./.zshrc
cat << 'EOF' >> $TEMP/./.zshrc
# nothing
EOF
genSignE zshplugins $TEMP/./.zshrc

# 配置文件 ./.p10k.zsh 
cat << 'EOF' >> $TEMP/./.p10k.zsh
# Generated by Powerlevel10k configuration wizard on 2024-07-26 at 20:17 CST.
...
# 2 lines, dotted, left frame, dark-ornaments, compact, few icons, concise,
